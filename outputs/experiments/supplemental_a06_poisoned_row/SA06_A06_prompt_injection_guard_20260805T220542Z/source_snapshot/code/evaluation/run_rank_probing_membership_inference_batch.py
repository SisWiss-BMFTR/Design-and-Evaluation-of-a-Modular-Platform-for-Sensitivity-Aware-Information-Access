...
def build_pipeline(shared: SharedComponents, access: str, retrieval_only: bool) -> RAGPipeline:
...
def run_single_case(
    ...
    access_control_failure = is_unauthorized and target_doc_present
            ...
            for conversation_length in conversation_lengths:
                ...
                for iteration in range(1, args.iterations + 1):
                    ...
                    print(
                        ...
                        f"acf={record.access_control_failure} "
