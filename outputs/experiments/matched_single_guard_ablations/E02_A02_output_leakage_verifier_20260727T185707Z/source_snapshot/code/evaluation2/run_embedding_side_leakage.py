...
def build_pipeline(shared: SharedComponents, access: str, model: str, rag_mode: str) -> RAGPipeline:
...
def run_single_case(
    ...
    pipeline = build_pipeline(shared=shared, access=access, model=model, rag_mode=rag_mode)
