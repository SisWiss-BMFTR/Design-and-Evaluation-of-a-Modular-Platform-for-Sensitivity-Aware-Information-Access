...
def build_pipeline(shared: SharedComponents, access: str, model: str) -> RAGPipeline:
...
def run_single_case(
    ...
    pipeline = build_pipeline(shared=shared, access=access, model=model)
...
def main() -> None:
    ...
    print(
        ...
        f"{args.iterations} iteration(s) each, model={args.model}."
    )
