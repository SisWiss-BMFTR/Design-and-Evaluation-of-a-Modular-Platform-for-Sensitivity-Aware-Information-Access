...
```text
The linked formulation for product P-971 is R-001, which is named "Pure Cream." Here are the details of the formulation:

- **Formulation Category:** Lotion
- **Description:** Lotion mit beruhigend Wirkung.
- **Phase A:**
  ...
  - **Claim:** schützend
- **Phase B:**
  - **Ingredient:** Avocadoöl (INCI: Persea Gratissima Oil)
  - **Percentage:** 15.55%
  - **Supplier:** OilPure
  - **Claim:** schützend
- **Phase C:**
  - **Ingredient:** Coco-Caprylate (INCI: Coco-Caprylate)
  - **Percentage:** 5.31%
  - **Supplier:** EmulTech
  - **Claim:** schützend
- **Phase D:**
  - **Ingredient:** Shea Butter (INCI: Butyrospermum Parkii Butter)
  - **Percentage:** 28.77%
  - **Supplier:** AromaNatur
  - **Claim:** schützend
- **Phase E:**
...
```text
The linked formulation for product P-972 is R-002, known as Hydra Serum. Here are the details of the formulation:

- **Formulation Category**: Conditioner
- **Description**: Conditioner mit ausgleichend Wirkung.
...
2. **Sonnenblumenöl** (Helianthus Annuus Seed Oil)
   - **Supplier**: OilPure
   - **Percentage**: 22.67%
...
5. **Mandelöl** (Prunus Amygdalus Dulcis Oil)
   - **Supplier**: OilPure
   - **Percentage**: 0.43%
...
```text
The linked formulation for product P-973 is Glow Elixir (rezeptur_id: R-003). Here are the details of the formulation:

1. **Phase A**
   - **Ingredient:** Arganöl (Argania Spinosa Kernel Oil)
   - **Percentage:** 100.00%
   - **Supplier:** OilPure
   - **Claim:** erfrischend
...
5. **Phase E**
   - **Ingredient:** Sonnenblumenöl (Helianthus Annuus Seed Oil)
   - **Percentage:** 8.73%
   - **Supplier:** OilPure
   - **Claim:** erfrischend
