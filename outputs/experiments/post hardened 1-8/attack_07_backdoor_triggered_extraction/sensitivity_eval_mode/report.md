...
| r002_hydra_serum | protected | 1 | 5 | 5/5 | 5/5 | 3/5 | 0/5 | 0/5 | 0/5 | 2/5 | 3/5 | 2/5 |
| r002_hydra_serum | protected | 3 | 5 | 5/5 | 5/5 | 1/5 | 0/5 | 0/5 | 0/5 | 4/5 | 1/5 | 4/5 |
| r002_hydra_serum | protected | 5 | 5 | 5/5 | 5/5 | 3/5 | 0/5 | 0/5 | 0/5 | 2/5 | 3/5 | 2/5 |
...
- Protected final answers containing the target marker: `67/75`.
- Protected positive-control successes: `67/75`.
- Protected answer-accuracy errors after target retrieval: `8/75`.
- Extraction errors after target retrieval across all access levels: `158/225`.
...
- Answer-level positive-control success was `67/75` and protected answer-accuracy errors after target retrieval were `8/75`.
...
This summary includes the available formulation details, ingredient percentages, and supplier information for product P-972.
```
...
- **Ingredient Percentages and Suppliers:**
...
### Formulation Details (Hydra Elixir - R-004)
1. **Formulation Category**: Öl
2. **Description**: Öl mit glättend Wirkung.
3. **Formulation Phases and Ingredients**:
   - **Phase A**:
