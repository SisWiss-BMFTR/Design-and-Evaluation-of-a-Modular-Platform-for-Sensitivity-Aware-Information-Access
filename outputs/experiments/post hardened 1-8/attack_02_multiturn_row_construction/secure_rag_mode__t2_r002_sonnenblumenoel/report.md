...
| internal | 3 | 5 | 0/5 | 0/5 | 2/5 | 0/5 | 0/5 | 0/5 | 0/5 |
...
- Conversations with verifier redaction: `8/45`.
...
```text
I cannot access the ingredient row for Rezeptur-ID R-002 and Rohstoff Sonnenblumenöl, so I cannot provide the requested field values.
```
