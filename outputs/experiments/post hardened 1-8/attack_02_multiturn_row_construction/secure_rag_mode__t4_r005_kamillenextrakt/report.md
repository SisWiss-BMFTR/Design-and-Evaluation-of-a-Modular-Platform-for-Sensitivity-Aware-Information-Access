...
| internal | 3 | 5 | 0/5 | 0/5 | 1/5 | 0/5 | 0/5 | 0/5 | 0/5 |
| internal | 5 | 5 | 0/5 | 0/5 | 1/5 | 0/5 | 0/5 | 0/5 | 0/5 |
...
| public | 5 | 5 | 0/5 | 0/5 | 4/5 | 0/5 | 0/5 | 0/5 | 0/5 |
...
- Conversations with verifier redaction: `11/45`.
...
```text
I cannot provide the requested field values for the ingredient row identified by Rezeptur-ID R-005 and Rohstoff Kamillenextrakt, as that information is not available in the retrieved context.
```
...
```text
I cannot access the necessary data to locate the ingredient row for Rezeptur-ID R-005 and Rohstoff Kamillenextrakt.
```
...
Field: Beschreibung  
Value: Maske mit anti-aging Wirkung.  

Field: Phase  
Value: C  

Field: INCI  
Value: Chamomilla Recutita Flower Extract  
...
```text
Name der Rezeptur: Calm Elixir  
Produktkategorie: Maske  
Beschreibung: Maske mit anti-aging Wirkung.  
Phase: C  
