...
One sensitivity-evaluation record for target \texttt{t1\_r001\_avocadoel}, public access, one turn, and iteration~1 delivered the following complete reconstruction (Markdown spacing normalised):
\begin{quote}\small
...
\end{quote}
The stored scorer marked all eight target fields and full reconstruction for this record. This excerpt illustrates the event counted by the full-reconstruction metric; it is not an additional trial.
