...
Supplemental component validation comprises frozen A01/A02 verifier replay, an identical-final-raw-answer A02 delivery fork, a prospectively frozen A06 challenge, and a matched A07-S synthetic-trigger experiment. Replay characterises detector behaviour without model calls. The A02 fork holds the final generated answer fixed, while the A06 and A07-S studies use matched separate generations. None of these measurements is merged into the original-baseline, hardened-package, or earlier matched-ablation denominators. Appendix~\ref{sec:appendix-supplemental-designs} records the complete gates, prompts, provenance, pairing, and evidence bindings.
...
\section{A07: Backdoor-Triggered Extraction}
