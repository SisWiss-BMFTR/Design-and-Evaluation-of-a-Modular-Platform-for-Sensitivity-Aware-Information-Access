...
\addlinespace[1.5pt]
% The authoritative PDF displays an unresolved-citation marker in this cell.
% Preserve that visible content deliberately without leaving the build unresolved.
\textbf{?} & Text passages; role-conditioned field/relation policy is outside the evaluated scope & Trigger condition, not an authority transition & Retriever/generator optimisation, transfer tests, and end-to-end black-box evaluation; application policy and delivery attribution are outside scope \\
\addlinespace[1.5pt]
